...
const ChatArea: React.FC<ChatAreaProps> = ({ messages, addMessage, updateToolSpecs }) => {
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full">
            ...
            <h2 className="text-xl font-montserrat font-bold text-sbd-charcoal mb-2">Tool Doctor</h2>
